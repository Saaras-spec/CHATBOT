...
9. **User-Controlled AI Behavior:** Allows adjustment of Temperature and Top-p directly from the UI.
10. **Dual Explanation Mode:** Users can toggle between Standard (detailed) and Simplified explanations.
